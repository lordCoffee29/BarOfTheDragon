...
export const TransactionViewModel = {
    async addPurchase(purchaseData, mode) {

        if (mode === "Liquor") {
            // Additional logic for liquor purchases can be added here
            const { storeName, storeLoc, date, item, packSize, brand, mL, ABV, type, quantity, price } = purchaseData;

            


        } else if (mode === "Base") {
            // Additional logic for base purchases can be added here
        } else if (mode === "Ingredient") {
            // Additional logic for ingredient purchases can be added here
        } else if (mode === "Tool") {
            // Additional logic for tool purchases can be added here
        }

        return await TransactionModel.create(purchaseData);  
    },
